...
<html>
	...
	<table class="data-table">
		...
		<?php
                                ...
                                $sql = "SELECT * FROM Book WHERE Seller='$user'";
		...
		while ($row = mysqli_fetch_array($query))
		{
			...
			echo '<tr>
					...
					<td>'.$locfinal['Location'] . '</td>
                                                                                          <td>'.$row['Price'].  '</td>
                                                                                          <td><form  action="" method="post" ><button input type="hidden" name="sub"  type="hidden" value=" '.$row['ID']. ' ">X</button></form></td>
				</tr>';
                                     ...
                                     if(isset($_POST['sub'])) {       
                                                                ...
                                                                if ($conn->query($sql) === TRUE ) {
                                                                    echo "<script type=\"text/javascript\">window.alert('Listing deleted.');
                                                                                    window.location.href = '/~gilesbr/books/main.php';</script>"; 
                                                                }
                                                                else {
                                                                     echo "<script type=\"text/javascript\">window.alert('Deletion failure');
                                                                                    window.location.href = '/~gilesbr/books/main.php';</script>"; 
                                                                }
                                                              }
